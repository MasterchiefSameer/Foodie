...
export default function SignUp({ onSwitchToSignIn }) {
  ...
  return (
    <div className="w-full max-w-md mx-auto p-6">
      ...
      <p className="text-center text-gray-600 mb-8">Join us to plan your meals smartly</p>
      ...
      <p className="text-center mt-6 text-gray-600">
        ...
        <button onClick={onSwitchToSignIn} className="text-green-600 hover:text-green-700 font-semibold">
          Sign In
        </button>
      </p>
    </div>
